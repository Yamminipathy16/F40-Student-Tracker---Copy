...
def staff_feedback(request):
    ...
    return render(request,"staff_template/staff_feedback.html",{"feedbacks":feedback_data})
...
def student_feedback_m(request):
    feedbacks=FeedBackStudent.objects.all()
    return render(request,"staff_template/student_feedback.html",{"feedbacks":feedbacks})
