...
urlpatterns = [
    ...
    path('edit_session', HodViews.edit_session,name="edit_session"),
    ...
    path('student_feedback_m', StaffViews.student_feedback_m,name="student_feedback_m"),
    path('student_feedback_reply', StaffViews.student_feedback_reply,name="student_feedback_reply"),
